module Chapter9.Examples.Shapes where

import Prelude
import Math as Math
import Control.Monad.Eff (Eff)
import Data.Maybe (Maybe(..))
import Graphics.Canvas (setStrokeStyle, CANVAS, closePath, lineTo, moveTo, fillPath, setFillStyle, arc, rect, getContext2D, getCanvasElementById)
