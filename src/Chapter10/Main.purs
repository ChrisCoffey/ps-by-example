module Chapter10.Main where

import Prelude

import Control.Monad.Eff (Eff)
import Chapter10.Control.Monad.Eff.Alert (ALERT, alert)
import Control.Monad.Eff.Console (CONSOLE, log)
import Control.Monad.Eff.Storage (STORAGE, setItem, getItem)
import Chapter10.Data.AddressBook (Address(..), Person(..), PhoneNumber(..), PhoneType(..), phoneNumber, address, person, examplePerson)
import Chapter10.Data.AddressBook.Validation (Errors, validatePerson')
...
import Chapter10.Data.JSON (stringify)
